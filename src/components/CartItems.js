        ...
        <section className='max_padd_container pt-28'>
            <table className='w-full mx-auto'>
                ...
                <tbody>
                    {all_products.map((e) => {
                        if (cartItems[e.id] > 0){
                            return <tr key={e.id} className='border-b border-slate-900/2 text-gray-30 p-6 medium-14 text-center'>
                                ...
                                {/* <td>{e.old_price}</td> */}
                                <td>
                                    <div className='bold-22 pl-14'><TbTrash onClick={() => removeFromCart(e.id)} className='cursor-pointer hover:text-red-600'/></div>
                                </td>
                            </tr>
                        }
                        return null
