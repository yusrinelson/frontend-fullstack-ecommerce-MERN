            ...
            <div className="flex flex-col gap-14 xl:flex-row">
                ...
                <div className="flex-col flex xl:flex-[1.7]">
                    ...
                    <div className="mb-4">
                        ...
                        <div onClick={() => {addToCart(product.id)}} className="flex flex-col gap-y-3 mb-4 max-w-[555px]">
                        ...
                        <p><span className="medium-16 text-terciary">Category :</span> Women | Jacket | Winter</p>
                        <p><span className="medium-16 text-terciary">Tags :</span> Modern | Latest</p>
                    </div>
                </div>
            </div>
        </section>
